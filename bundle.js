...
;// CONCATENATED MODULE: ./src/scripts/menu.js
/* provided dependency */ var $ = __webpack_require__(755);


/* harmony default export */ const menu = (() => {
  document.querySelector('.main__wrapper').scrollTo({
    left: 0,
    behavior: 'smooth'
  });
});
...
function clickBackMenuHandler(event) {
...
var src = __webpack_require__(344);
;// CONCATENATED MODULE: ./src/scripts/index.js
/* provided dependency */ var scripts_$ = __webpack_require__(755);
...
const makeActiveLink = event => {
  if (event.target.classList.contains('navigation__link') && event.target.classList.contains('links__link')) {
    return;
  }
...
function init() {
  ...
  switcher.addEventListener('click', function () {
    ...
    if (sidebar.classList.contains('sidebar_night-mode')) {
      ...
      [...document.querySelectorAll('.order')].forEach(element => element.classList.add('order_night-mode'));
      ...
      document.querySelector('.logo').style.filter = ''; // document.querySelector('.headline__image').srcset =
      //   './assets/img/face.png 320w, ./assets/img/faceBig.png 769w';

      [...document.querySelectorAll('.order')].forEach(element => element.classList.remove('order_night-mode'));
    ...
    document.querySelector('.logo').style.filter = `brightness(0) saturate(100%) invert(91%) sepia(100%) saturate(0%) hue-rotate(306deg) brightness(108%) contrast(101%)`;
  ...
  document.querySelector('.headline__button-wrapper').addEventListener('click', menu);
  setWidthCarousel();
  [...document.querySelectorAll('.back-menu')].forEach(element => element.addEventListener('click', clickBackMenuHandler));
  ...
  if (window.innerWidth <= 768) {
    document.querySelector('#initial-screen').scrollIntoView({
      behaviour: 'instant'
    });
    [...document.querySelectorAll('[href="#jeynix"]')].forEach(element => element.addEventListener('click', function (event) {
      event.preventDefault();
      scripts_$('.main__wrapper').animate({
        scrollLeft: window.innerWidth - 50 + 60
      }, 1000, 'easeInOutCirc');
    }));
    [...document.querySelectorAll('[href="#make-video"]')].forEach(element => element.addEventListener('click', function (event) {
      event.preventDefault();
      scripts_$('.main__wrapper').animate({
        scrollLeft: (window.innerWidth - 50) * 2 + 60
      }, 1000, 'easeInOutCirc');
    }));
    [...document.querySelectorAll('[href="#deep-fake"]')].forEach(element => element.addEventListener('click', function (event) {
      event.preventDefault();
      scripts_$('.main__wrapper').animate({
        scrollLeft: (window.innerWidth - 50) * 3 + 60
      }, 1000, 'easeInOutCirc');
    }));
    [...document.querySelectorAll('[href="#old-videos"]')].forEach(element => element.addEventListener('click', function (event) {
      event.preventDefault();
      scripts_$('.main__wrapper').animate({
        scrollLeft: (window.innerWidth - 50) * 4 + 60
      }, 1000, 'easeInOutCirc');
    }));
    [...document.querySelectorAll('[href="#contacts"]')].forEach(element => element.addEventListener('click', function (event) {
      event.preventDefault();
      scripts_$('.main__wrapper').animate({
        scrollLeft: (window.innerWidth - 50) * 5 + 60
      }, 1000, 'easeInOutCirc');
    }));
    [...document.querySelectorAll('[href="#about"]')].forEach(element => element.addEventListener('click', function (event) {
      event.preventDefault();
      scripts_$('.main__wrapper').animate({
  ...
  [...document.querySelectorAll('.order__video-wrapper, .order__overlay')].forEach(element => element.style.height = document.querySelector('.initial-image').height + 2 <= 100 ? '361px' : document.querySelector('.initial-image').height - 18 + 'px');
  document.querySelector('.initial-wrapper').style.height = document.querySelector('.initial-image').height + 2 <= 100 ? '361px' : document.querySelector('.initial-image').height + 2 + 'px';
}
...
[...document.querySelectorAll('.order__video')].forEach(element => element.addEventListener('load', resizeBlock)); // document.querySelector('.order__img').addEventListener('load', resizeBlock);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("662e49cabc351398c934")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "solution:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatesolution"] = (chunkId, moreModules, runtime) => {
